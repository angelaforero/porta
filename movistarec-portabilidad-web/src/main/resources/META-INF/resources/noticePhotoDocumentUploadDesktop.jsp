	...
	<div class="row">
		...
		<div class="col-md-8 padding-0">
			...
			<div class="container-information-notice-document">
				...
				<div class="row container-dashed-upload">
					<div class="col-md-12">
			...
			<div class="d-flex justify-content-between footer-container desk">
				<div>
					<button class="cancel-btn-squater d-flex align-items-center" onclick="showContinue(1)">
				...
				<div>
					<button class="continue-btn-squater d-flex align-items-center justify-content-end" type="submit" name="submit" onclick="showContinue(3)">
