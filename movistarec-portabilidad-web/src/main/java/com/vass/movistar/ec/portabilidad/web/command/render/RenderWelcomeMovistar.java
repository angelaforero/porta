...
@Component(immediate = true, property = {
		...
		"mvc.command.name=render-welcome-movistar" }, service = MVCRenderCommand.class)
public class RenderWelcomeMovistar  implements MVCRenderCommand {

	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		return "/welcomeMovistar.jsp";
	}
