...
@Component(immediate = true, property = {
		...
		"mvc.command.name=render-send-chip-data" }, service = MVCRenderCommand.class)
public class RenderSendChipData  implements MVCRenderCommand {

	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		return "/sendChipData.jsp";
	}
